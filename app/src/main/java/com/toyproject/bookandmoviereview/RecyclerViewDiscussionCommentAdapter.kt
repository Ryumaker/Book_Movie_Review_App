...
class RecyclerViewDiscussionCommentAdapter constructor(private val context: Context, private val replyList: List<ReplyData>)
    : RecyclerView.Adapter<RecyclerViewDiscussionCommentAdapter.ViewHolder>() {
